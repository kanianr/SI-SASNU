...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <br>
    <h1 class="h3 mb-0 text-gray-800" align="center">Data Surat Masuk</h1>
</div>
...
<section id="services-list" class="services-list">
    ...
    <div class="card border-dark " style="max-width: 22rem;" align="center">
        <div class="card-header  border-success"><b>FILTER LAPORAN SURAT MASUK</b></div>
        <div class="card-body text-success">
            <h5 class="card-title"></h5>
            <form action="sortingmasuk.php" method="POST">
