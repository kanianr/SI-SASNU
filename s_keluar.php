    ...
    <section id="services-list" class="services-list">
        <div class="container">
            ...
            <div class="section-header">
                <h2 id="s_keluar">Arsip Surat Keluar</h2>
            </div>
            <div><a href="<?php echo ('p_keluar.php'); ?>"><button type="button" class="btn btn-primary"><b>PRINT</b></button></a></div><br>
            <center>
                <form class="form-inline my-2 my-lg-0">
                    <div align='left'><a href="tambah_keluar.php"><img src="assets/img/TAMBAH.png" width='3%'> Tambah Data</a></div>
                </form>
            </center>
            <table id="tabel">
                <thead>
                ...
                <tbody>
                    ...
                    <?php
                    include "koneksi.php";
                    $query = mysqli_query($db, "SELECT * FROM surat_keluar");
                    $no = 1;
                    ...
                    ?>
                        <tr align="center">
                            ...
                            <td width='10%'>
                                <div align='center'>
                                    <a href="ubah_keluar.php?id=<?= $data['id'] ?>"><img src="assets/img/update.png" width='25%'></a>
...
if (isset($_GET['hapus'])) {
    ...
    $hapus = mysqli_query($db, "DELETE FROM surat_keluar WHERE kode_surat='$kode_surat'");
    if ($hapus) {
        header("location: s_keluar.php");
    } else {
