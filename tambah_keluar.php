...
<body>
        ...
        <table>
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <td><input type="text" name="pengaju" required></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><a href="s_keluar.php"> kembali </a></td>
                </tr>
            </form>
        </table>
    </div>
    ...
    if (isset($_POST['simpan'])) {
        ...
        $simpan = mysqli_query($db, "INSERT INTO surat_keluar VALUES ('$id','$kode_surat','$nomor_surat','$tanggal','$pengaju','$kepada','$perihal','$pengirim','$penerima','$file','$id_staff')");
        if ($simpan) {
