    ...
    <section id="services-list" class="services-list">
        <div class="container">
            ...
            <div class="section-header">
                <h2 id="pegawai">Data Pegawai</h2>
            </div>
            <div><a href="<?php echo ('p_pegawai.php'); ?>"><button type="button" class="btn btn-primary"><b>PRINT</b></button></a></div><br>

            <center>
                <form class="form-inline my-2 my-lg-0">
                    <div align='left'><a href="tambah_pegawai.php"><img src="assets/img/TAMBAH.png" width='3%'> Tambah Data</a></div>
                </form>
            </center>
            <br>
            <table id="tabel">
                ...
                <tbody>
                    ...
                    ?>
                        <tr align="center">
                            ...
                            <td width='10%'>
                                <div align='center'>
                                    <a href="ubah_pegawai.php?id=<?= $data['id'] ?>"><img src="assets/img/update.png" width='25%'></a>
                                    <a href="?hapus&id=<?= $data['id']; ?>"><img src="assets/img/delete.png" width='25%'></a>
                                </div>
                            </td>
                        </tr>
                    <?php
...
if (isset($_GET['hapus'])) {
    $id = $_GET['id'];
    $hapus = mysqli_query($db, "DELETE FROM pegawai WHERE id='$id'");
    if ($hapus) {
        $hapus = mysqli_query($db, "DELETE FROM user WHERE id_staff='$id'");
